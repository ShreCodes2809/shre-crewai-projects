...
class TrendingCompany(BaseModel):
    ...
    ticker: str = Field(description="Stock finder symbol")
...
class TrendingCompanyResearchList(BaseModel):
    ...
    research_list: List[TrendingCompanyResearch] = Field(description="Comprehensive list of researches on all the trending companies")
